...
class _CustomGameStoresService implements CustomGameStoresService {
  ...
  @override
  Future<HttpResponse<GenreResponse>> getGenres() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<GenreResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          'https://game-store-api-eirs.onrender.com/api/Genre',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
